...
// 1. Page Layer - Will create a package or folder (pages) -- Locators and method related to specific page
// LoginPage.js, DashboardPage.js, CartPage.ts ....

// 2. Test Layer - Pure test case and assertions - tests folder
// LoginPageTest.spec.js, DashboardPageTest.spec.js .....

// 3. Test Data - JSON/Excel- TestData.json, TestData.xlsx
// 4. Utils - API methods, screenshot, scrolling, read the data from the excel
